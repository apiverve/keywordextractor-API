...
const (
	baseURL        = "https://api.apiverve.com/v1/keywordextractor"
	defaultTimeout = 30 * time.Second
)

// Client is the Keyword Extractor API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Keyword Extractor API client.
...
// Execute makes a request to the Keyword Extractor API with typed parameters.
//
