...
namespace APIVerve\Keywordextractor;
...
/**
 * Client for the Keyword Extractor API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/keywordextractor?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/keywordextractor';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\KeywordextractorClient] {$message}\n";
        }
    }
}
