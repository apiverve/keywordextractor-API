...
```gradle
dependencies {
    implementation 'com.github.apiverve:keywordextractor-api:1.1.14'
}
```
...
```java
import com.apiverve.keywordextractor.KeywordExtractorAPIClient;
import com.apiverve.keywordextractor.APIResponse;
import com.apiverve.keywordextractor.APIException;

// Initialize the client
KeywordExtractorAPIClient client = new KeywordExtractorAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("text", "example");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/keywordextractor](https://docs.apiverve.com/ref/keywordextractor)
...
- **Documentation:** [https://docs.apiverve.com/ref/keywordextractor](https://docs.apiverve.com/ref/keywordextractor)
- **Issues:** [GitHub Issues](https://github.com/apiverve/keywordextractor-api/issues)
